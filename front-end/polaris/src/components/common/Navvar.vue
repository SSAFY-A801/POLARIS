<template>
    <nav class="fixed mt- bg-white top-20 w-full z-30 shadow-lg">
        <div class="px-12 mx-0 ">
            <div class="flex items-center h-24">
              <div class=" flex items-center justif-center w-full h-24">
                 ...
                 <div class="flex ml-auto flex-row px-20">
                     ...
                     <p  v-if="userToken && loginUser.id !== undefined && loginUser.id !== null" class="text-maintheme1 font-bold mt-4 mr-4" >{{ loginUser.nickname }}</p>
                     <router-link v-if="userToken && loginUser.id !== undefined && loginUser.id !== null" 
                                 :to="{ name: 'ProfilePage', params: { id: loginUser.id }}" 
                                 class="text-maintheme1 mr-14"><img class="col-span-1 object-cover" id="profile-image" :src="loginUser.profileUrl ? loginUser.profileUrl : '@/assets/profile-default.jpg'" alt="@\assets\profile-default.jpg"></router-link>
