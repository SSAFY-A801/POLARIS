...
const bookDetail = computed(() => {
  ...
  if (store.userPopularBookList) {
    return store.userPopularBookList[id-1] || { isbn: "", cover: "", title: "", author: "", publisher: "", pubDate: "", bookDescription: "", priceStandard: ""  }
  } else {
    return { isbn: "", cover: "", title: "", author: "", publisher: "", pubDate: "", bookDescription: "", priceStandard: ""  }
  }
})
